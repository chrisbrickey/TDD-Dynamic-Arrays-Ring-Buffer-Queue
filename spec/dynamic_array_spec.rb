...
#TDD: If we want to test the time complexity of push/pop/shift/unshift,
# ...we should be testing the actual time complexity (compare to linear time)
# ...If I test whether or not a 'resize' helper method is called (doubles size of underlying array),
# ...then I'm testing the implementation not the behavior - misses the point of testing
